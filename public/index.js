...
var cards = db.collection("cards").document("cards/cards");
...
function addCard() {
    ...
    if (!name || !type || !description || !rarity) {
        alert ("You forgot to enter an input for something! Every field is required!" + name + type + description + type + rarity);
